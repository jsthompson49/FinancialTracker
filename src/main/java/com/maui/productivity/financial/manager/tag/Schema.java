...
public class Schema {
    ...
    public static List<TagRule> TAG_RULES = List.of(
            new DescriptionPatternTagRule(".*(?i)(AMERICAN STRATEGIC INSURA).*", CATEGORY_REAL_ESTATE_COUNTY_ROAD_F),
            ...
            new DescriptionPatternTagRule(".*(?i)(CHUCK & DON).*", CATEGORY_PETS),
            ...
            new DescriptionPatternTagRule(".*(?i)(ALMA).*", CATEGORY_RESTAURANTS),
            ...
            new DescriptionPatternTagRule(".*(?i)(EL SAZON COCINA).*", CATEGORY_RESTAURANTS),
            ...
            new DescriptionPatternTagRule(".*(?i)(NOUVELLE BREW).*", CATEGORY_RESTAURANTS),
            ...
            new DescriptionPatternTagRule(".*(?i)(POTSTICKER).*", CATEGORY_RESTAURANTS),
            new DescriptionPatternTagRule(".*(?i)(PRYES BREWING).*", CATEGORY_RESTAURANTS),
            ...
            new DescriptionPatternTagRule(".*(?i)(SUNSHINE FACTORY BAR).*", CATEGORY_RESTAURANTS),
            ...
            new DescriptionPatternTagRule(".*(?i)(TAVERN GRIL).*", CATEGORY_RESTAURANTS),
            ...
            new DescriptionPatternTagRule(".*(?i)(MAINSTREAM BOUTIQUE).*", CATEGORY_SHOPPING),
            ...
            new DescriptionPatternTagRule(".*(?i)(Verizon Wrls M3094).*", CATEGORY_SHOPPING),
            ...
            new DescriptionPatternTagRule(".*(?i)(THE BREW STATION).*", CATEGORY_TRAVEL),
            new DescriptionPatternTagRule(".*(?i)(CAFE DUTCHESS).*", CATEGORY_TRAVEL),
            ...
            new DescriptionPatternTagRule(".*(?i)(HCGW-SNACKBAR).*", CATEGORY_RESTAURANTS),
